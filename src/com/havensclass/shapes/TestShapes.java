...
public class TestShapes {
    public static void main(String[] args) {
        ...
        Triangle triangle = new Triangle(new Point(0.0, 0.0), 1.0, 1.0, 1.0, 1.0);
        ...
        System.out.println("Triangle is at: (" + triangle.getPosition().getX() +
        ...
        System.out.println("Perimeter of triangle is: " + triangle.computePerimeter());
        System.out.println();
    }
}